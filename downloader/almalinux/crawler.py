#!/usr/bin/env python3
"""
AlmaLinux kernel image crawler.

Reads config.yaml in this directory, then crawls vault.almalinux.org for
el8 and el9 kernel-core RPMs.

Usage:
    python3 downloader/almalinux/crawler.py [--list] [--verbose] [--dry-run]
"""
import re
import sys
import os
